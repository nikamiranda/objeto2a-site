...
function NexusScrollStory() {
  ...
  return (
    <section className="nexus-story" id="metodo" ref={sectionRef} aria-label="Como a Objeto 2A atua">
      <div className="nexus-story__pin" ref={pinRef}>
        <div className="nexus-story__progress" aria-hidden="true">
          <i></i><i></i><i></i>
        </div>
        <span className="nexus-story__scroll-hint">Role para explorar <i>↓</i></span>
